...
export const IS_NOT_EMPTY: (errorText?: string) => IValidation = (
    errorText = ""
) => {
    return {
        order: 0,
...
export const MIN_LENGTH: (min: number, errorText?: string) => IValidation = (
    min,
    errorText = ""
) => {
    return {
...
export const MAX_LENGTH: (max: number, errorText?: string) => IValidation = (
    max,
    errorText = ""
) => {
    return {
...
export const EMAIL_ADDRESS: (errorText?: string) => IValidation = (
    errorText = ""
) => {
    return {
        order: 3,
...
export const IS_NUMERIC: (errorText?: string) => IValidation = (
    errorText = ""
) => {
    return {
        order: 3,
