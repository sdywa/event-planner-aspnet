...
import { IEvent, IExtendedEvent } from "../../types";
    ...
    return (
        <PageLayout title={event.title} isCentered={true} header={
            ...
            <div className="flex justify-center items-center gap-4 py-4 relative">
                <div className="flex flex-col justify-center items-start gap-4 text-xl">
                    <div className="w-[44rem] h-[25rem] relative bg-lightgray rounded-md text-xl">
                        {
